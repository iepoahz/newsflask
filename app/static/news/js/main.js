$(function(){
    ...
    $(".login_form_con").submit(function (e) {
        ...
        var image_code = $(".login_form #image_code").val()
    ...
    $(".register_form_con").submit(function (e) {
        ...
        var password1 = $("#register_password-1").val()
        ...
        if (!password) {
            $("#register-password-err-1").html("请填写密码!");
            $("#register-password-err-1").show();
            return;
        }

		if (password.length < 6) {
            $("#register-password-err-1").html("密码长度不能少于6位");
            $("#register-password-err-1").show();
            return;
        }
